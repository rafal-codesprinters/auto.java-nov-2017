 ...
 */
public class WpPostPage extends WpPage {
    ...
    public boolean IsCommentPosted(String commentText, String commentAuthorName) {
    ...
    public boolean IsReplyPosted(String commentText, String commentAuthorName, String replyText, String replyAuthorName) {
        By commentLocator = GetPostedCommentLocator(commentText, commentAuthorName);
        WebElement postedComment = driver.findElement(commentLocator);
